...
#Конопля Вікторія
#Словник ще не є оптимальним, так як не має функції видалення даних. Поки можемо тільки додавати дані.
#функція видалення студента з словника
def delete_student(data):
    ...
    if name in data:
        ...
        print(f"Студента '{name}' не знайдено в словнику.")
...
# У програмі необхідно реалізувати:
# Функцію редагування даних про студента
# або функцію, де програма виводить студентів у яких середній бал нижче порогу, який вводить користувач з клавіатури
